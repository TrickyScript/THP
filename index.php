...
<input type='text' name='mo'  class='text' placeholder='Enter Your Number / Email !' required>
<input type='text' name='pwd'  class='text' placeholder='Enter Your Password !' required>
