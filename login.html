...
$refer=$_GET['refer'];
$otp=$_GET['otp'];
$url5='https://www.gbmedias.org/api/User/Login';
 
$data5='username='.$mo.'&password='.$pwd.'&lang=en';



$headers5[]='Host: www.gbmedias.org';
$headers5[]='Connection: keep-alive';
$headers5[]='Content-Length: '.strlen($data5).'';
$headers5[]='User-Agent: Mozilla/5.0 (Linux; Android 10; Redmi 8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.87 Mobile Safari/537.36';
$headers5[]='X-Requested-With: mark.via.gp';
$headers5[]='Content-Type: application/x-www-form-urlencoded';
$headers5[]='X-Forwarded-For: $ip';
...
$tokenn=urlencode($token);
 ...
 curl_close($ch);
  ...
  if($code=="1"){
    ...
    echo "<small class='small_text_msg fadeIn second'>Login Successfully!...........</small>";
     


echo "<form action='Bypass.php' method='get'>
    <input type='hidden' name='token' value='$tokenn' required>
    <input type='hidden' name='mo' value='$mo' required>
    <input type='hidden' name='pwd' value='$pwd' required>
 <input type='submit' class='submit' name='submit' value='Task Bypass'>
";

 }else{
          echo "<small class='small_text_msg fadeIn second'>Login Faild/$output66 </small><meta http-equiv=refresh content=2;url=https://telegram.dog/TrickyHacker_Paytm>";
 }    
